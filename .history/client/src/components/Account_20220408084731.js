...
const Account = () => {
  ...
  const [membersAddress, setMembersAdress] = useState("0xDBF84248124cD22aC17E0Ea42be2C895C15D9a2b");
  const [isLoaning, setIsLoaning] = useState("false");
  const [groupName, setGroupName] = useState("Maendeleo")
  return (
    <div>
      <Container className="mt-5 mx-9">
        <h3 className="text-bold">Hello {groupName}, The following are your fellow members</h3>
